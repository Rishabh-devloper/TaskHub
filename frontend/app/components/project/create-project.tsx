...
import { CalendarIcon, FolderPlus, Users, Tag, Calendar as CalendarDays } from "lucide-react";
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="Describe what this project is about and its goals..."
                        rows={4}
                        className="bg-white/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-400 transition-all duration-200 resize-none"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
